...
One last gotcha: `typeof` is different with *TDZ* variables than it is with undeclared variables.
...
Now it should be clearer why I strongly prefer -- no, I insist -- the `let` declarations all be at the top of the scope. It totally avoids the accidental errors of accessing too early. It also makes it more *explicit* when you look at the start of a block, any block, what variables it contains.
